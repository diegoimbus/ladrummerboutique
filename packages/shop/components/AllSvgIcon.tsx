...
export const MeatFish = ({
  ...
  return (
    <svg
      ...
      width={width}
      height={height}
      viewBox='0 0 482.382 482.382'
    >
        <path d="M378.205,239.638c-21.615-33.623-54.52-73.181-93.074-111.967l14.469-14.603c2.915-2.942,2.894-7.691-0.05-10.606c-2.941-2.916-7.69-2.894-10.606,0.049l-14.472,14.606c-33.314-32.495-68.048-61.646-98.406-82.533C153.133,18.807,121.445,0,100.702,0C93.8,0,88.306,2.013,84.372,5.983c-11.977,12.089-5.313,38.029,19.806,77.102
